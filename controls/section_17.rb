...
control "xccdf_org.cisecurity.benchmarks_rule_17.6.1_L1_Ensure_Audit_Other_Object_Access_Events_is_set_to_Success_and_Failure" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.6.2_L1_Ensure_Audit_Removable_Storage_is_set_to_Success_and_Failure" do
